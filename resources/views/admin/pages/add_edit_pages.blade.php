...
@method('PUT')
@else
<form id="crudTable" action="{{ route('pages.store') }}" method="POST"  enctype="multipart/form-data">
@endif  
      @csrf
              <div class="row mt-3">
              <div class="col-sm-1">
            ...
            <div class="row mt-3">
              ...
              <div class="col-sm-8 pl-4">
                <textarea id="page_editor" name="description" rows="8" cols="50" class="form-control ckeditor" required="required">{{old('description',$page->description??'')}}</textarea>
               ...
               <div class="col-sm-1">
                ...
                <div class="col-sm-3 pl-4">
                  <button type="submit" class="btn btn-outline-success btn-sm mt-3">Save</button>
                      <a href="{{url('admin/pages')}}" class="btn btn-outline-danger btn-sm mt-3">Back</a>
